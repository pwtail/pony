...
class TestInheritance(unittest.TestCase):
    ...
    @raises_exception(
        ERDiagramError,
        "Attribute Entity3.a conflicts with attribute Entity2.a "
    ...
    @raises_exception(
        TypeError,
        "Discriminator value for entity Entity1 "
    ...
    @raises_exception(
        TypeError,
        "Incorrect discriminator value is set for Entity2 attribute 'a' of 'int' type: 'zzz'",
    )
    def test_10(self):
        db = self.db
    ...
    def test_13(self):
        ...
        self.assertEqual(
            [index.attrs for index in Entity2._indexes_],
    ...
    def test_17(self):
        ...
        self.assertEqual(
            [index.attrs for index in Entity1._indexes_],
    ...
    @raises_exception(
        TypeError,
        "Invalid discriminator attribute value for Foo. Expected: 'Foo', got: 'Baz'",
    )
