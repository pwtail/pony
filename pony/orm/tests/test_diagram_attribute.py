...
class TestAttribute(unittest.TestCase):
    ...
    @raises_exception(
        TypeError, "Attribute Entity1.id has unknown option 'another_option'"
    )
    ...
    @raises_exception(
        TypeError,
        "Cannot link attribute Entity1.b to abstract Entity class. Use specific Entity subclass instead",
    )
    ...
    @raises_exception(
        TypeError, "Default value for required attribute Entity1.b cannot be None"
    )
    ...
    @raises_exception(
        TypeError,
        "Value of 'reverse' option must be name of reverse attribute). Got: 123",
    )
    ...
    @raises_exception(
        ERDiagramError,
        "Attribute name cannot both start and end with underscore. Got: _attr1_",
    )
    ...
    @raises_exception(
        ERDiagramError, "Duplicate use of attribute Entity1.attr1 in entity Entity2"
    )
    ...
    @raises_exception(
        ERDiagramError, "Invalid use of attribute Entity1.a in entity Entity2"
    )
    ...
    @raises_exception(
        ERDiagramError,
        "Cannot create default primary key attribute for Entity1 because name 'id' is already in use."
    ...
    @raises_exception(
        ERDiagramError,
        "Inconsistent reverse attributes Entity3.attr3 and Entity2.attr2",
    )
    ...
    @raises_exception(
        ERDiagramError,
        "Ambiguous reverse attribute for Entity1.a. Use the 'reverse' parameter for pointing to right attribute",
    )
    ...
    @raises_exception(
        ERDiagramError,
        "Ambiguous reverse attribute for Entity1.c. Use the 'reverse' parameter for pointing to right attribute",
    )
    ...
    @raises_exception(
        ERDiagramError, "Inconsistent reverse attributes Entity1.a and Entity2.b"
    )
    ...
    @raises_exception(
        ERDiagramError, "Inconsistent reverse attributes Entity1.a and Entity2.c"
    )
    def test_attribute23(self):
        db = self.db
    ...
    def test_attribute24(self):
        ...
        self.assertTrue(
            "AUTOINCREMENT" not in db.schema.tables[table_name].get_create_command()
        )
    ...
    @raises_exception(
        MappingError, "Invalid number of columns specified for Entity2.attr2"
    )
    ...
    @raises_exception(
        TypeError, "Items of parameter 'columns' must be strings. Got: [1, 2]"
    )
    ...
    def test_columns12(self):
        ...
        class Entity1(db.Entity):
            attr1 = Set(
                ...
                reverse="attr1",
                column="column1",
                reverse_column="column2",
                reverse_columns=["column2"],
            )
    ...
    @raises_exception(
        TypeError, "Parameter 'reverse_columns' must be a list. Got: 'column3'"
    )
    def test_columns15(self):
        ...
        class Entity1(db.Entity):
            attr1 = Set(
                "Entity1", reverse="attr1", column="column1", reverse_columns="column3"
            )

        db.generate_mapping(check_tables=False)

    @raises_exception(
        TypeError, "Parameter 'reverse_columns' must be a list of strings. Got: [5]"
    )
    def test_columns16(self):
        ...
        class Entity1(db.Entity):
            attr1 = Set(
                "Entity1", reverse="attr1", column="column1", reverse_columns=[5]
            )
    ...
    @raises_exception(
        TypeError,
        "Invalid type of attribute Entity1.a: expected entity class, got 'Entity2'",
    )
    ...
    @raises_exception(
        ValueError,
        "Check for attribute Entity1.a failed. Value: datetime.date(1999, 1, 1)",
    )
    ...
    @raises_exception(
        ValueError,
        "Value for attribute Entity1.a is too long. Max length is 10, value length is 10000",
    )
