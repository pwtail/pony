...
from pony.orm.tests import setup_database
...
class TestCollections(unittest.TestCase):
    ...
    @raises_exception(
        TypeError,
        "Collection attribute Group.students cannot be specified as search criteria",
    )
    ...
    @raises_exception(
        TypeError,
        "When using Group.students.create(), "
    ...
    @raises_exception(
        ...
        "Object Student[105] cannot be stored in the database...",
    )
    @db_session
    ...
    @raises_exception(
        TypeError,
        "When using Group.subjects.create(), "
