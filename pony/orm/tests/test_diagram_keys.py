...
class TestKeys(unittest.TestCase):
    ...
    @raises_exception(
        ERDiagramError, "Only one primary key can be defined in each entity class"
    )
    def test_keys3(self):
        db = self.db = Database(**db_params)
    ...
    @raises_exception(
        TypeError, "composite_key() must receive at least two attributes as arguments"
    )
    ...
    @raises_exception(
        TypeError, "composite_key() arguments must be attributes. Got: 123"
    )
    ...
    @raises_exception(
        TypeError, "composite_key() arguments must be attributes. Got: %r" % int
    )
    ...
    @raises_exception(
        TypeError, "Set attribute Entity1.b cannot be part of unique index"
    )
    ...
    @raises_exception(
        TypeError,
        "'unique' option cannot be set for attribute Entity1.b because it is collection",
    )
    ...
    @raises_exception(
        TypeError, "Optional attribute Entity1.b cannot be part of primary key"
    )
    ...
    @raises_exception(
        TypeError, "PrimaryKey attribute Entity1.a cannot be of type float"
    )
    ...
    @raises_exception(
        TypeError, "Attribute Entity1.b of type float cannot be part of primary key"
    )
    ...
    @raises_exception(
        TypeError, "Attribute Entity1.b of type float cannot be part of unique index"
    )
    ...
    @raises_exception(
        TypeError, "Volatile attribute Entity1.b cannot be part of primary key"
    )
