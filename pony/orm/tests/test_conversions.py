...
class Test(unittest.TestCase):
    def test_timestamps_1(self):
        ...
        td = converting.str2timedelta(s)
        self.assertEqual(
            td, timedelta(hours=1, minutes=2, seconds=3, microseconds=456780)
        )
        s = "12:34:56"
        td = converting.str2timedelta(s)
        ...
        td = converting.str2timedelta(s)
        self.assertEqual(
            td, timedelta(hours=12, minutes=34, seconds=56, milliseconds=789)
        )
        s = "12:34:56.789123"
        td = converting.str2timedelta(s)
        self.assertEqual(
            td, timedelta(hours=12, minutes=34, seconds=56, microseconds=789123)
        )
