...
class TestAttributeOptions(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        with orm.db_session:
            ...
            p3 = Person(
                ...
                lastName="Craig",
                middleName=None,
                timeStmp="2010-12-10 14:12:09.019473",
                vehicle="dodge",
            )
    ...
    def test_columnName(self):
        self.assertEqual(Person.vehicle.column, "car")
    ...
    @raises_exception(
        ValueError,
        "Value 61 of attr Person.age is greater than the maximum allowed value 60",
    )
    ...
    @raises_exception(
        ValueError,
        "Value 9 of attr Person.age is less than the minimum allowed value 10",
    )
